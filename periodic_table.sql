...
--
-- Name: type_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.type_id_seq OWNER TO freecodecamp;

--
-- Name: type_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.type_id_seq OWNED BY public.types.type_id;
...
ALTER TABLE ONLY public.types ALTER COLUMN type_id SET DEFAULT nextval('public.type_id_seq'::regclass);
...
--
-- Name: type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--
